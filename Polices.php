                            ...
                            <div class="col-md-8">
                                ...
                                ?>
                                    ...
                                    <div border="0" width="100px" bordercolor="#FF6666">
                                        ...
                                        <div>
                                            <div align="center" style="background-color:#60B0E6; font-size:20px; font-family:Lucida Calligraphy; color:#FFF"><?php echo $row[1]; ?> </div>
                                        </div>

                                        <div>
                                            <div align="center" style="background-color:#60B0E6; font-family:Lucida Calligraphy"><a href="policedistrict.php?regid=<?php echo $row[0]; ?>">
