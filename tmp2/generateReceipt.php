...
<html lang="en">
	...
	<head>
		...
		<title>Receipt | Tour&Travel</title>
					...
					<div class="col-sm-10 boxCenter">
						...
						<div class="col-sm-4">
							...
							<div class="serialNo text-center">
								...
								<span class="rupee">BDT </span><?php echo $row["price"]; ?>
						...
						<div class="col-sm-4">
							...
							<div class="serialNo text-center">
								...
								<span class="rupee">BDT </span><?php echo $fare ?>
			...
			<div class="importantInfo">
				...
				<div class="col-sm-10">
					...
					<div class="info">
						...
						<span class="strong">2.</span> It is mandatory to have a Government recognised photo identification (ID) when checking-in. This can include: Driving License, Passport, National ID Card or any other ID issued by the Government.
