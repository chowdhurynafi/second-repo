...
<html lang="en">
	...
	<head>
		...
		<title>E-Ticket | Tour&Travel</title>
			...
			<div class="importantInfo">
				...
				<div class="col-sm-10">
					...
					<div class="info">
						...
						<span class="strong">2.</span> Check-in starts 2 hours before scheduled departure and closes 30 minutes prior to the departure time. We recommend you report at the check-in counter at least 2 hours prior to the departure time.
						
					</div>
					
					<div class="info">
						
						<span class="strong">3.</span> It is mandatory to carry Government recognised photo identification (ID) along with your E-Ticket. This can include: Driving License, Passport, National ID Card or any other ID issued by the Government. For infant passengers, it is mandatory to carry the Date of Birth certificate.
