	...
	<div class="col-xs-12 home">
			...
			<div class="col-xs-12 destinationHolder">
				...
				<div class="col-xs-12 containerGrids hvr-buzz-out">
					<a href="bus.php" style="color: black;">
						...
						<div class="col-xs-12 icons text-center">
							<img src="images/icons/bus.png" style="width:300px;height:300px;" alt="Bus" class="iconsDim text-center" />
						</div>
				...
				<div class="col-xs-12 containerGrids hvr-buzz-out">
					<a href="guides.php" style="color: black;">

						<div class="col-xs-12 icons text-center">
							<img src="images/icons/guide.png" style="width:300px;height:300px;" alt="Guide" class="iconsDim text-center" />
						</div>
				...
				<div class="col-xs-12 containerGrids hvr-buzz-out">
					<a href="polices.php" style="color: black;">

						<div class="col-xs-12 icons text-center">
							<img src="images/icons/police.png" style="width:300px;height:300px;" alt="Guide" class="iconsDim text-center" />
						</div>
				...
				<div class="col-xs-12 destinationHolder">
					...
					<div class="col-xs-12 containerGrids hvr-buzz-out">
						...
						<div class="col-xs-12 pics text-center">
							<img src="images/popularDestinations/coxsbazar.jpg" alt="popularDestination1" class="picDim text-center" />
						</div>
					...
					<div class="col-xs-12 containerGrids hvr-buzz-out">
						...
						<div class="col-xs-12 pics text-center">
							<img src="images/popularDestinations/sylhet.jpg" alt="popularDestination1" class="picDim text-center" />
						</div>
					...
					<div class="col-xs-12 containerGrids hvr-buzz-out">
						...
						<div class="col-xs-12 pics text-center">
							<img src="images/popularDestinations/dhaka.jpg" alt="popularDestination1" class="picDim text-center" />
						</div>
		...
		<div class="footerMod col-sm-12">
			...
			<div class="col-sm-4">
				...
				<div class="footerText">
					E-mail: queries@tour&travel.com
				</div>


				<div class="footerText">
					<a href="guideApply.php">Become a Guide</a>
				</div>
			...
			<div class="col-sm-4">
				...
				<div class="socialLinks">
					...
					<div class="fb">
						facebook.com/tour&travel
					</div>

					<div class="gp">
						plus.google.com/tour&travel
					</div>

					<div class="tw">
						twitter.com/tour&travel
					</div>

					<div class="in">
						linkedin.com/tour&travel
					</div>
