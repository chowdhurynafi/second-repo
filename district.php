    ...
    <div class="col-sm-12 aboutUsWrapper">
        ...
        <div style="width:1000px; margin:auto">
            ...
            <div class="container_fluid">
                <div class="heading" style="font-size: 30px;">Find Guide by District</div>
                <div class="col-md-8">
                    ...
                    ?>
                            ...
                            <div border="0" width="100px" bordercolor="#FF6666">
                                ...
                                <div>
                                    <div align="center" style="background-color:#60B0E6; font-family:Lucida Calligraphy"><a href="guideinfo.php?districtid=<?php echo $row['districtID']; ?>">
