                        ...
                        <form action="carSearch.php" method="POST">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="originCar">Origin:<p> </p></label>

                                    <select id="originCar" data-live-search="true" class="selectpicker form-control" data-size="8" title="Select Origin " name="origin" required>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="destinationCar">Destination:<p> </p></label>

                                    <select id="destinationCar" data-live-search="true" class="selectpicker form-control" data-size="8" title="Select Destination " name="destination" required>
                                        <optgroup label="Chattogram Division">
                                            <option value="Chattogram" data-tokens="Chattogram">Chattogram District</option>
                                            <option value="Brahmanbaria" data-tokens="Brahmanbaria">Brahmanbaria District</option>
                                            <option value="Cumilla" data-tokens="Cumilla">Cumilla District</option>
                            ...
                            <div class="col-sm-3">
                                ...
                                <div class="form-group">
                                    <select id="class" class="selectpicker form-control" data-size="5" title="Select Class" name="type" required>
                            ...
                            <div class="col-sm-3">
                                <label for="adults">No. of seats:<p> </p></label>
                                <div class="form-group">
                                    <select id="adults" class="selectpicker form-control" data-size="5" title="No. of seats" name="seats" required>
                            ...
                            <div class="col-sm-12 text-center">
                                ...
                                <input type="submit" class="button" name="searchBus" value="Search Car">
