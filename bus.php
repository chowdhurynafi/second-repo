						...
						<form action="busSearch.php" method="POST">
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<select id="originBus" data-live-search="true" class="selectpicker form-control" data-size="8" title="Select Origin " name="origin" required>
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<select id="destinationTrain" data-live-search="true" class="selectpicker form-control" data-size="8" title="Select Destination " name="destination" required>
										<optgroup label="Chattogram Division">
											<option value="Chattogram" data-tokens="Chattogram">Chattogram District</option>
											<option value="Brahmanbaria" data-tokens="Brahmanbaria">Brahmanbaria District</option>
											<option value="Cumilla" data-tokens="Cumilla">Cumilla District</option>
							...
							<div class="col-sm-3">
								...
								<label for="children">Bus operators:<p> </p></label>
								<div class="form-group">
									<select id="children" class="selectpicker form-control" data-size="5" title="Bus Operator" name="operators" required>
