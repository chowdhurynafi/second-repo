    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full" data-sidebar-position="absolute" data-header-position="absolute" data-boxed-layout="full">
        ...
        <div class="page-wrapper">
            ...
            <div class="row col-md-6" style="display: flex;">
                <div class="col-md-4 ">
                    <a href="#busdata">
                        <div class=" btn-primary btn-block btn-lg">Bus Data</div>
                    </a>
                </div>
                <div class="  col-md-4">
                    <a href="#busdata">
                        <div class="  btn-primary btn-block btn-lg">Bus Bookings</div>
                    </a>
                </div>
            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form method="post" action="">
                                <h4>Bus ID (Use to Search Bus's detail)</h4>
                                <input type="number" name="busID" class="form-control" placeholder="Hotel ID /Automatic Number Genrates" value="<?php echo ($buslID); ?>" disabled>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-xs-6">
                                        <h4>Operator</h4>
                                        <select id="operator" data-live-search="true" class="selectpicker form-control" data-size="5" title="Select Operator" name="operator" value="<?php echo ($operator); ?>" required>
                                    ...
                                    <div class="col-xs-6">
                                        <h4>Type</h4>
                                        <select id="type" data-live-search="true" class="selectpicker form-control" data-size="5" title="Select type" name="type" value="<?php echo ($type); ?>" required>
                                            <option value="Chair (Non AC)" data-tokens="Chair (Non AC)">Chair (Non AC)</option>
                                            <option value="Chair (AC)" data-tokens="Chair (AC)">Chair (AC)</option>
                                            <option value="Sleeper (AC)" data-tokens="Sleeper (AC)">Sleeper (AC)</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-xs-6">
                                            <h4>Origin</h4>
                                            <select id="originBus" data-live-search="true" class="selectpicker form-control" placeholder="Enter origin" data-size="8" title="Select Origin" value="<?php echo ($origin); ?>" name="origin" required>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-xs-6">
                                                <h4>Destination</h4>
                                                <select id="destinationBus" data-live-search="true" class="selectpicker form-control" placeholder="Enter destination" data-size="8" title="Select Destination" name="destination" value="<?php echo ($destination); ?>" required>
                                                    <optgroup label="Chattogram Division">
                                                        <option value="Chattogram" data-tokens="Chattogram">Chattogram District</option>
                                                        <option value="Brahmanbaria" data-tokens="Brahmanbaria">Brahmanbaria District</option>
                                                        <option value="Cumilla" data-tokens="Cumilla">Cumilla District</option>
                                            ...
                                            <div class="col-xs-6">
                                                <h4>Departure</h4>
                                                <input type="time" name="departure" class="form-control" placeholder="Enter origin time" value="<?php echo ($departure); ?>" required>
                                            </div>

                                            <div class="col-xs-6">
                                                <h4>Arrival </h4>
                                                <input type="time" name="arrival" class="form-control" placeholder="Enter destination time" value="<?php echo ($arrival); ?>" required>
                                            </div>
                                            ...
                                            <div class="col-xs-6">
                                                <h4>Seat</h4>
                                                <input type="number" name="seat" class="form-control" placeholder="Enter no. of available rooms" value="<?php echo ($seat); ?>" required>
                                            </div>

                                            <div>
                                                <input type="submit" class="btn btn-success btn-block btn-lg" name="insert" value="Add">
                                                <a href="busUpdate.php" class="btn btn-info btn-block btn-lg">Update | Delete | Search</a>
                                            </div>
                                        </div>
                            </form>
                        </div>
            ...
            <div class="container-fluid" id="busdata">
