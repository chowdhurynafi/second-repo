...
<body>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full" data-sidebar-position="absolute" data-header-position="absolute" data-boxed-layout="full">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid" id="guides">
                ...
                <div class="row">
                    ...
                    <div class="white-box">
                        ...
                        <div class="table-responsive">
                            <h1 class="text-danger text-center" style="font-weight:bold">All Guide Details</h1>
            ...
            <div class="container-fluid" id="guides">
                ...
                <div class="row">
                    ...
                    <div class="white-box">
                        ...
                        <div class="table-responsive">
                            <h1 class="text-danger text-center" style="font-weight:bold">All hired Guide </h1>

                            <div>
                                <?php
                                require_once 'Database_conn.php';

                                $sql2 = "SELECT * FROM guides where hiring ='yes'";
