    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full" data-sidebar-position="absolute" data-header-position="absolute" data-boxed-layout="full">
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Add Trains</h4>
                    </div>
            ...
            <div class="row col-md-6" style="display: flex;">
                <div class="col-md-4 ">
                    <a href="#data">
                        <div class=" btn-primary btn-block btn-lg">Train Data</div>
                    </a>
                </div>
                <div class="  col-md-4">
                    <a href="#booking">
                        <div class="  btn-primary btn-block btn-lg">Train Bookings</div>
                    </a>
                </div>
            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-xs-6">
                                                            <h4>Origin Code</h4>
                                                            <select id="origincode" data-live-search="true" class="selectpicker form-control" data-size="5" title="Select Origin Code" value="<?php echo ($originCode); ?>" name="originCode" required>
                                                        ...
                                                        <div class="col-xs-6">
                                                            ...
                                                            <select id="destinationcode" placeholder="Enter destination" data-live-search="true" class="selectpicker form-control" data-size="5" title="Select Destination Code" value="<?php echo ($destinationCode); ?>" name="destinationCode" required>
                                                                <option value="DAC" data-tokens="DAC Dhaka">Dhaka (DAC)</option>
                                                                <option value="JSR" data-tokens="JSR Jashore">Jashore (JSR)</option>
                                                                <option value="BZL" data-tokens="BZL Barishal">Barishal (BZL)</option>
                                                                <option value="CGP" data-tokens="CGP Chattogram">Chattogram (CGP)</option>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-xs-6">
                                                                    <h4>Classes</h4>
                                                                    <input type="text" name="classes" class="form-control" placeholder="Enter available classes(1AC, 2AC, 3AC......" value="<?php echo ($classes); ?>" required>

                                                                </div>

                                                                <div class="col-xs-6">
                                                                    <h4>Seats First Class Chair</h4>
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <a href="trainUpdate.php" class="btn btn-info btn-block btn-lg">Update | Delete | Search</a>
                                                                    <br>
                                                                    <br>
                ...
                <div class="row">
                    ...
                    <div class="white-box">
                        ...
                        <div class="table-responsive">
                            ...
                            echo " <table class='table text-nowrap  table-striped table-hover py-5 ' style='width:100%; text:white; text-align: center;float:left'>
