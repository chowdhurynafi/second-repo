...
if (isset($_POST['insert'])) {
    $info = getData();
    $insert_query = "INSERT INTO `cabs`(`origin`, `destination`, `distance`,`time`,`originCode`,`destinationCode`,`fare`) VALUES ('$info[1]','$info[2]','$info[3]','$info[4]','$info[5]','$info[6]','$info[7]')";
    try {
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form method="post" action="">
                                ...
                                <div class="col-xs-6">
                                    <h4>Origin</h4>
                                    <select id="originCab" data-live-search="true" class="selectpicker form-control" placeholder="Enter origin" data-size="8" title="Select Origin" value="<?php echo ($origin); ?>" name="origin" required>
                                ...
                                <div class="form-group row">
                                    <div class="col-xs-6">
                                        <h4>Destination</h4>
                                        <select id="destinationcab" data-live-search="true" class="selectpicker form-control" placeholder="Enter destination" data-size="8" title="Select Destination" name="destination" value="<?php echo ($destination); ?>" required>
                                            <optgroup label="Chattogram Division">
                                                <option value="Chattogram" data-tokens="Chattogram">Chattogram District</option>
                                                <option value="Brahmanbaria" data-tokens="Brahmanbaria">Brahmanbaria District</option>
                                                <option value="Cumilla" data-tokens="Cumilla">Cumilla District</option>
                                ...
                                <div class="col-xs-6">
                                    <h4>Origin Code</h4>
                                    <select id="origin" data-live-search="true" class="selectpicker form-control" data-size="5" title="Select Origin Code" value="<?php echo ($originCode); ?>" name="originCode" required>
                                ...
                                <div class="col-xs-6">
                                    ...
                                    <select id="destination" placeholder="Enter destination" data-live-search="true" class="selectpicker form-control" data-size="5" title="Select Destination Code" value="<?php echo ($destinationCode); ?>" name="destinationCode" required>
                                        <option value="DAC" data-tokens="DAC Dhaka">Dhaka (DAC)</option>
                                        <option value="JSR" data-tokens="JSR Jashore">Jashore (JSR)</option>
                                        <option value="BZL" data-tokens="BZL Barishal">Barishal (BZL)</option>
                                        <option value="CGP" data-tokens="CGP Chattogram">Chattogram (CGP)</option>
                                ...
                                <div>
                                    ...
                                    <a href="cabUpdate.php" class="btn btn-info btn-block btn-lg">Update | Delete | Search</a>
                                    <br>
                                    <br>
                ...
                <div class="row">
                    ...
                    <div class="white-box">
                        ...
                        <div class="table-responsive">
                            <h1 class="table text-danger text-center">Cab INFORMATION</h1>
                            <hr>
