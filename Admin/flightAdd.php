        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Add Flights</h4>
                    </div>
            ...
            <div class="container">
                ...
                <div class="row col-md-6" style="display: flex;">
                    <div class="col-md-4 ">
                        <a href="#data">
                            <div class=" btn-primary btn-block btn-lg">Flight Data</div>
                        </a>
                    </div>
                    <div class="  col-md-4">
                        <a href="#booking">
                            <div class="  btn-primary btn-block btn-lg">Flight Bookings</div>
                        </a>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            <form method="post" action="">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-xs-6">
                                        <h4>Destination</h4>
                                        <select id="destination" placeholder="Enter destination" data-live-search="true" class="selectpicker form-control" data-size="5" title="Select Destination" value="<?php echo ($destination); ?>" name="destination" required>
                                            <option value="Dhaka" data-subtext="DAC" data-tokens="DAC Dhaka">Hazrat Shahjalal International Airport, Dhaka</option>
                                            <option value="Jashore" data-subtext="JSR" data-tokens="JSR Jashore">Jashore Airport, Jashore</option>
                                            <option value="Barishal" data-subtext="BZL" data-tokens="BZL Barishal">Barishal Airport, Barishal</option>
                                            <option value="Chattogram" data-subtext="CGP" data-tokens="CGP Chattogram">Shar Amanat International Airport, Chattogram</option>
                                    ...
                                    <div class="col-xs-6">
                                        ...
                                        <select id="destination" placeholder="Enter destination" data-live-search="true" class="selectpicker form-control" data-size="5" title="Select Destination Code" value="<?php echo ($destination_code); ?>" name="destination_code" required>
                                            <option value="DAC" data-tokens="DAC Dhaka">Dhaka (DAC)</option>
                                            <option value="JSR" data-tokens="JSR Jashore">Jashore (JSR)</option>
                                            <option value="BZL" data-tokens="BZL Barishal">Barishal (BZL)</option>
                                            <option value="CGP" data-tokens="CGP Chattogram">Chattogram (CGP)</option>
                                    ...
                                    <div class="col-xs-6">
                                        ...
                                        <input type="date" name="date" placeholder="Enter Departure Date" class="form-control" value="<?php echo ($date); ?>" required>
                                    </div>
                                </div>

                                <div>
                                    <input type="submit" class="btn btn-success btn-block btn-lg" name="insert" value="Add">
                                    <a href="flightUpdate.php" class="btn btn-info btn-block btn-lg">Update | Delete | Search</a>
                                    <br>
                                    <br>
