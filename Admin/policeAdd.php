...
if (isset($_POST["submit"])) {
    ...
    $sql = "INSERT INTO `touristpolice`(`name`, `region`, `district`, `map`, `designation`, `phone`) VALUES ( '$name',' $region ' ,'$district','$map','$designation','$phone')";
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full" data-sidebar-position="absolute" data-header-position="absolute" data-boxed-layout="full">
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Add Tourist Police</h4>
                    </div>
            ...
            <div class="row col-md-6" style="display: flex;">
                <div class="col-md-4 ">
                    <a href="#busdata">
                        <div class=" btn-primary btn-block btn-lg">Police Data</div>
                    </a>
                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form method="post" action="">
                                <h4>Police ID (Use to Search police's detail)</h4>
                                <input type="number" name="policeID" class="form-control" placeholder="Police ID /Automatic Number Genrates" value="" disabled>

                                <div class="form-group row">
                                    <div class="col-xs-6">
                                        <h4>Name</h4>
                                        <input type="text" name="name" class="form-control" placeholder="Enter police Name " value="<?php echo $policeName; ?>" required>
                                    </div>
                                    ...
                                    <div class="col-xs-6">
                                        <h4>designation</h4>
                                        <input type="text" name="designation" class="form-control" placeholder="Enter designation " value="" required>
                                    </div>
