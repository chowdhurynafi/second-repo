        ...
        <div class="page-wrapper">
            ...
            <div class="container">
                ...
                <div class="row col-md-6" style="display: flex;">
                    <div class="col-md-4 ">
                        <a href="#data">
                            <div class=" btn-primary btn-block btn-lg">Hotel Data</div>
                        </a>
                    </div>
                    <div class="  col-md-4">
                        <a href="#booking">
                            <div class="  btn-primary btn-block btn-lg">Hotel Bookings</div>
                        </a>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            <form method="post" action="">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-xs-6">
                                        <h4>City</h4>
                                        <select id="city" data-live-search="true" class="selectpicker form-control" data-size="5" title="Select City" name="city" value="<?php echo ($city); ?>" required>
                                ...
                                <div>
                                    ...
                                    <a href="hotelUpdate.php" class="btn btn-info btn-block btn-lg">Update | Delete | Search</a>
